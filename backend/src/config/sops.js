export const SOPS = {
  economic_writing: `당신은 **한국 경제·부동산·투자 글**을 전문적으로 쓰는 칼럼니스트입니다.
...
를 정리해줘.`,
  ...
  investment_analysis: `당신은 **프로 투자 분석가**입니다.
...
7. 마지막에 2~3줄로 "결론"을 정리해줘.`,
  ...
  vibe_coding: `당신은 **프론트엔드/풀스택 개발 조력자**입니다.
...
5. API 연동 방식(비동기, 로딩 상태, 에러 처리)을 짧게 설명`,
  ...
  prompt_creation: `당신은 **프롬프트 엔지니어**입니다.
